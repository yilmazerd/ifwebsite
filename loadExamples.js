...
exampleOneCode+= 'Returns a very simple JSON structure and 502 HTTP code\n'
...
exampleOneCode+= 'Person person = new Person("Thomas21","Edison");\n'
exampleOneCode+= 'InstantFunctionResponse.responseBuilder(502,person.toString());\n'
exampleOneCode+= '}\n'
exampleOneCode+= '}\n'
...
exampleOneCode+= '            responseBuilder(502, responseObject);\n'
exampleOneCode+= '        }\n'
